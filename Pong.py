...
class Game:
    def __init__(self, ai_mode=False):  # Thêm tham số ai_mode mặc định là False
        pygame.init()
        ...
        self.ai_mode = ai_mode  # Nhận giá trị ai_mode từ tham số
    ...
    def start(self):
        ...
        while running:
            ...
            self.screen.fill((255, 192, 203))  # Màu hồng
